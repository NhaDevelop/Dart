...
import 'package:experiment_app1/FinalProject/Pages/ticket_detail.dart';
import 'package:experiment_app1/FinalProject/Pages/ticket_page.dart';
import 'package:experiment_app1/FinalProject/const.dart';
import 'package:experiment_app1/FinalProject/model/seats_model.dart';
  ...
  child: GestureDetector(
    onTap: () {
      if (selectedSeats.isNotEmpty) {
        // Save ticket details to TicketState
        TicketState.saveTicket(
          seats: selectedSeats,
          time: selectedTime,
          price: selectedSeats.length * 20,
        );
